      ...
      <main className="flex-grow py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 p-8 lg:p-12">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
              <div>
                ...
                <p className="text-slate-500 mt-2 text-lg">
                  Welcome back, {session?.user?.name}! Manage your account and
                  settings here.
                </p>
              </div>
              <button
            ...
            {/* Modal */}
            {isModalOpen && (
              <div className="fixed inset-0 z-50000000 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
